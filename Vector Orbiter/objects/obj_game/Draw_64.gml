...
//draw_text(curs_x, curs_y, "x: " + string(cursor_x-curs_x) + "\ny: " + string(cursor_y-curs_y));
//}
...
#region esc prompt
	draw_sprite_ext(escape_sprite,0, bottom_right_x - row_width,bottom_right_y - row_height,sprite_scale,sprite_scale, 0,c_white, 1);
		if(!instance_exists(obj_game) || (global.liveProjectiles ==0 && obj_game.levelScore == 0)){
