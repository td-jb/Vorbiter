...
function __input_config_verbs()
{
    return {
        keyboard_and_mouse:
        {
            ...
            destruct: input_binding_mouse_button(mb_right),
			precision: input_binding_key(vk_control),
			last_shot: input_binding_key(vk_lshift),
			zoom_out: input_binding_mouse_wheel_up(),
			zoom_in: input_binding_mouse_wheel_down(),
        ...
        gamepad:
        {
            ...
            destruct:     [ input_binding_gamepad_button(gp_shoulderlb)],
			precision: input_binding_gamepad_button(gp_shoulderl),
			last_shot: input_binding_gamepad_button(gp_padl),
			zoom_out: input_binding_gamepad_button(gp_padu),
			zoom_in: input_binding_gamepad_button(gp_padd),
            
			reset: input_binding_gamepad_button(gp_select),
